    ...
    switch (uploadType) {
      case "logo":
        return {
          ...
          errorMessage: IMAGE_ERROR_MESSAGES.INVALID_LOGO_TYPE,
          guideline: "PNG, SVG, JPG 형식 지원",
        };
      case "favicon":
        return {
          config: FAVICON_UPLOAD_CONFIG,
          errorMessage: IMAGE_ERROR_MESSAGES.INVALID_FAVICON_TYPE,
          guideline: "ICO, PNG 형식 지원",
        };
      default:
        return {
