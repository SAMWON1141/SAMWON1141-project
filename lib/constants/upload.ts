...
export const ALLOWED_FAVICON_TYPES = ["image/x-icon", "image/png"] as const;
export const ALLOWED_FAVICON_EXTENSIONS = [".ico", ".png"] as const;
...
// 파비콘 업로드 설정
export const FAVICON_UPLOAD_CONFIG = {
  maxSize: MAX_UPLOAD_SIZE,
...
export const IMAGE_ERROR_MESSAGES = {
  ...
  INVALID_FAVICON_TYPE:
    "지원하지 않는 파일 형식입니다. ICO, PNG 파일만 업로드 가능합니다.",
